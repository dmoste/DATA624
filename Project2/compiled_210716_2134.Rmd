...
```{r, include=FALSE}
# Load data
to_model <- read.csv("https://raw.githubusercontent.com/dmoste/DATA624/main/Project2/StudentDataTOMODEL.csv")
to_predict <- read.csv("https://raw.githubusercontent.com/dmoste/DATA624/main/Project2/StudentEvaluationTOPREDICT.csv")
```
...
pred_final <- predict(nnetTune, transformed_pred[,-1])
```